...
Key references:
- @D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/USER-PROFILE.md" "D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/commands/gsd/dev-preferences.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/CLAUDE.md
```

...
<template>
@D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/templates/UAT.md
</template>
...
Read and follow `D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/workflows/transition.md`.
...
```bash
node "D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```
...
- Follow @D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/workflows/diagnose-issues.md

...
See D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/templates/discovery.md
...
Use D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/templates/discovery.md.

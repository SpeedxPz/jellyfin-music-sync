...
<required_reading>
@D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/references/ai-frameworks.md
@D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/agents/gsd-eval-planner.md for instructions.

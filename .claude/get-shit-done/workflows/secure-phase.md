...
```
Task(
  prompt="Read D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/templates/SECURITY.md`

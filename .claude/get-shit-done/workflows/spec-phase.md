...
```bash
INIT=$(node "D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/templates/spec.md.

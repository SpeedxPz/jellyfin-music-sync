...
```markdown
Read D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/agents/gsd-ui-checker.md for instructions.

...
- **Global scope**: `D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/notes/`)
...
2. Glob `D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/notes/*.md` (if directory exists) — global notes
...
Global (D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/notes/` — works in any directory

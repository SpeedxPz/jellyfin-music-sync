...
```bash
node "D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/templates/retrospective.md`.

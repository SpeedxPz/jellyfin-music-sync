...
- Usage: Reference from command with `@D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

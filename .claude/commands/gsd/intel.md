...
Project root: ${CWD}
Prefer: gsd-sdk query <subcommand> (installed gsd-sdk on PATH). Legacy: node D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/bin/gsd-tools.cjs

...
<execution_context>
@D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/workflows/spike-wrap-up.md
...
<process>
Execute the spike-wrap-up workflow from @D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/workflows/spike-wrap-up.md end-to-end.

...
<execution_context>
@D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/workflows/code-review-fix.md
</execution_context>
...
Execute the code-review-fix workflow from @D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/workflows/code-review-fix.md end-to-end.

...
<execution_context>
@D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/workflows/manager.md
...
<process>
Execute the manager workflow from @D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/workflows/manager.md end-to-end.

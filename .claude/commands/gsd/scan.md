...
<execution_context>
@D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/workflows/scan.md
</execution_context>

<process>
Execute the scan workflow from @D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/workflows/scan.md end-to-end.
</process>

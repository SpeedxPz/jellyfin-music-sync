...
<execution_context>
@D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/workflows/docs-update.md end-to-end.

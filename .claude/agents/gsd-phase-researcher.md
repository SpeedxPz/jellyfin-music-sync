...
@D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/references/thinking-models-research.md
...
```bash
node "D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```

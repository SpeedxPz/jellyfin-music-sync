...
<required_reading>
@D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude
                  → checks D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done
                  → writes to D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/hooks/
...
@D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/User Storage/Documents/1.code/jellyfin-music-sync/.claude/get-shit-done/references/common-bug-patterns.md
